...
def train_epoch(model, optimizer, device, data_loader, epoch, writer = None):
    ...
    for iter, (batch_graphs, batch_targets) in enumerate(data_loader):
        ...
        # graph = images.ndata['feat'], images.edata['feat']
        ...
        # if iter == 0:# the model.forward(inputs, outputs, should be tensors, can not take 'g')
        #     writer.add_graph(model, (batch_graphs, batch_x, batch_e))

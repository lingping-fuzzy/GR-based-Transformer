...
from layers.graph_transformer_global_layer_cly import GraphTransformerLayer as GATLayer
...
class GATNet(nn.Module):
    def __init__(self, net_params):
        ...
        self.embedding_e = nn.Linear(1, hidden_dim * num_heads)
        if self.lap_pos_enc:
    ...
    def forward(self, g, h, e, h_lap_pos_enc=None):
        ...
        if self.lap_pos_enc:
            h = self.embedding_lap_pos_enc(h_lap_pos_enc)
        else:

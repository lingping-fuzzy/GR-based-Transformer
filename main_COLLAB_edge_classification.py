    ...
    try:
        ...
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                epoch_train_loss, optimizer = train_epoch(model, optimizer, device, graph, train_edges, params['batch_size'], epoch)
                
                epoch_train_hits, epoch_val_hits, epoch_test_hits = evaluate_network(
                    model, device, graph, train_edges, val_edges, val_edges_neg, test_edges, test_edges_neg, evaluator, params['batch_size'], epoch)
...
def main():    
    ...
    #args.config = "conf/configCLE/COLLAB_edge_classification_GAT_40k.json"
